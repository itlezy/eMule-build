...
CALL build_MSBuild_eMule-zlib-1.2.12.cmd
IF %ERRORLEVEL% NEQ 0 (
...
CALL build_MSBuild_eMule-libpng-1.5.30.cmd
IF %ERRORLEVEL% NEQ 0 (
...
CALL build_MSBuild_eMule-CxImage-7.02.cmd
IF %ERRORLEVEL% NEQ 0 (
...
CALL build_MSBuild_eMule-cryptopp-8.4.0.cmd
IF %ERRORLEVEL% NEQ 0 (
...
CALL build_MSBuild_eMule-mbedtls-2.28.cmd
IF %ERRORLEVEL% NEQ 0 (
...
CALL build_MSBuild_eMule-miniupnp-2.2.3.cmd
IF %ERRORLEVEL% NEQ 0 (
...
CALL build_MSBuild_eMule-id3lib-3.9.1.cmd
IF %ERRORLEVEL% NEQ 0 (
...
CALL build_MSBuild_eMule-ResizableLib.cmd
IF %ERRORLEVEL% NEQ 0 (
