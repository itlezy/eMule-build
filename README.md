# eMule-build `v0.60d-broadband-clean`

This branch is the `broadband-clean` child workspace for the `eMule` `v0.60d` four-stage app stack.
...
- The clean broadband seed repo lives at `eMule-v0.60d-broadband-clean`. Additional variants live as `eMule-v0.60d-build-clean`, `eMule-v0.60d-bugfix-clean`, and `eMule-v0.60d-experimental-clean` worktrees under this workspace when created by `setup` or `bootstrap`.
