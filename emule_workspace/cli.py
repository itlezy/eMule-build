...
def _live_e2e_options(function: F) -> F:
    ...
    @click.option("--rest-cold-start-dump-stress-downloads-per-wave", default=120, show_default=True, type=int)
    @click.option("--rest-cold-start-dump-stress-downloads-per-search", default=10, show_default=True, type=int)
